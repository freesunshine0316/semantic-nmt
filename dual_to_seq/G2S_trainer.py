...
def main(_):
    ...
    if os.path.exists(best_path + ".index"):
        ...
        print('Number of words (on both sides): {}'.format(len(allWords)))
    ...
    trainDataStream = G2S_data_stream.G2SDataStream(trainset, word_vocab_enc, word_vocab_dec, char_vocab, edgelabel_vocab, options=FLAGS,
