...
class CovAttenGen:
    ...
    def attention(self, decoder_state, attention_vec_size, encoder_states, encoder_features, encoder_mask, v, w_c=None,
    ...
    def one_step_decoder(self, state_t_1, context_encoder_t_1, context_src_t_1, coverage_t_1, word_t,
        ...
        with variable_scope.variable_scope("encoder_attn"):
            context_encoder_t, _, _ = self.attention(state_t, options.attention_vec_size, encoder_states,
                    encoder_features, encoder_mask, v_enc, w_c=w_c,
                    use_coverage=False, coverage=None) # don't use coverage on AMR side

        with variable_scope.variable_scope("src_attn"):
            context_src_t, attn_dist, coverage_t = self.attention(state_t, options.attention_vec_size, src_states,
        ...
        return (state_t, context_encoder_t, context_src_t, coverage_t, attn_dist, vocab_score_t)

    def train_mode(self, vocab,
            encoder_dim, encoder_states, encoder_features, encoder_mask,
        ...
        if options.use_coverage:
            coverage_t_1 = tf.zeros([batch_size, passage_len])
        else:
            coverage_t_1 = None
        ...
        with variable_scope.variable_scope("attention_decoder"):
            ...
            for i in range(options.max_answer_len):
                ...
                (state_t, context_encoder_t, context_src_t, coverage_t, attn_dist_t, output_t) = self.one_step_decoder(
    ...
    def decode_mode(self, word_vocab, beam_size, state_t_1, context_encoder_t_1, context_src_t_1, coverage_t_1, word_t,
                    encoder_states, encoder_features, encoder_mask, src_states, src_features, src_mask):
        options = self.options
        ...
        return (state_t, context_encoder_t, context_src_t, coverage_t, attn_dist_t, output_t, topk_log_probs, topk_ids,
